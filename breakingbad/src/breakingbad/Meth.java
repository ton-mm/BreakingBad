...
public class Meth extends baseBlock {
    /**
	...
	public Meth(int posX,int posY)
		...
		super(posX,posY);	
                //
                Image meths = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("Imagenes/meth.png"));
                
                
                anim = new Animacion();
                anim.sumaCuadro(meths, 100);
                anim.sumaCuadro(meths, 100);
