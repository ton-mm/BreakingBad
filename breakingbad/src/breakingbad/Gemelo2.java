...
public class Gemelo2 extends baseBlock {
    /**
	...
	public Gemelo2(int posX,int posY)
        {
		super(posX,posY);	
                //
                Image oso1 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("Imagenes/twin 2.png"));
