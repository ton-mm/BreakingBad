...
public class SenorZalamanca extends baseBlock {
    /**
	...
	public SenorZalamanca(int posX,int posY)
        {
		super(posX,posY);	
                //
                Image oso1 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("Imagenes/señor.png"));
