...
public class Gemelo1 extends baseBlock {
    /**
	...
	public Gemelo1(int posX,int posY)
        {
		super(posX,posY);	
                //
                Image oso1 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("Imagenes/twin 1.png"));
