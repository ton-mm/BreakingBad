...
public class Malo2 extends baseBlock {
    /**
	...
	public Malo2(int posX,int posY)
        {
		super(posX,posY);	
                //
                Image oso1 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("Imagenes/malo2.png"));
