...
public class Malo3 extends baseBlock {
    /**
	...
	public Malo3(int posX,int posY)
        {
		super(posX,posY);	
                //
                Image oso1 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("Imagenes/malo3.png"));
