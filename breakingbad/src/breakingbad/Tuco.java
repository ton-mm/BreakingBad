...
public class Tuco extends baseBlock {
    /**
	...
	public Tuco(int posX,int posY)
        {
		super(posX,posY);	
                //
                Image oso1 = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("Imagenes/tuco.png"));
